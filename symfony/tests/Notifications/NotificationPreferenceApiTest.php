...
class NotificationPreferenceApiTest extends WebTestCase
{
    ...
    {
        $this->client->request('GET', '/api/notification_preferences');
    ...
    {
        $this->client->request('POST', '/api/notification_preferences', [], [], ['CONTENT_TYPE' => 'application/json'],
            json_encode([
            'emailEnabled' => true,
            'pushEnabled' => true,
            'inAppEnabled' => true,
    ...
    {
        $this->client->request('GET', '/api/notification_preferences/' . $this->entityId);
        $this->assertResponseIsSuccessful();
        $this->assertResponseStatusCodeSame(200);
    }
    ...
    {
        $this->client->request('PATCH', '/api/notification_preferences/' . $this->entityId, [], [], ['CONTENT_TYPE' => 'application/json'],
    ...
    {
        $this->client->request('DELETE', '/api/notification_preferences/' . $this->entityId);
