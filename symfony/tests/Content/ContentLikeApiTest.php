...
class ContentLikeApiTest extends WebTestCase
{
    ...
    {
        $this->client->request('GET', '/api/content_likes');
    ...
    {
        $this->client->request('POST', '/api/content_likes', [], [], ['CONTENT_TYPE' => 'application/json'],
            json_encode([
    ...
    {
        $this->client->request('GET', '/api/content_likes/' . $this->entityId);
        $this->assertResponseIsSuccessful();
        $this->assertResponseStatusCodeSame(200);
    }
    ...
    {
        $this->client->request('PATCH', '/api/content_likes/' . $this->entityId, [], [], ['CONTENT_TYPE' => 'application/json'],
    ...
    {
        $this->client->request('DELETE', '/api/content_likes/' . $this->entityId);
