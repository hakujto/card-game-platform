...
class BookmarkApiTest extends WebTestCase
{
    ...
    {
        $this->client->request('GET', '/api/bookmarks');
    ...
    {
        $this->client->request('POST', '/api/bookmarks', [], [], ['CONTENT_TYPE' => 'application/json'],
            json_encode([
    ...
    {
        $this->client->request('GET', '/api/bookmarks/' . $this->entityId);
        $this->assertResponseIsSuccessful();
        $this->assertResponseStatusCodeSame(200);
    }
    ...
    {
        $this->client->request('PATCH', '/api/bookmarks/' . $this->entityId, [], [], ['CONTENT_TYPE' => 'application/json'],
    ...
    {
        $this->client->request('DELETE', '/api/bookmarks/' . $this->entityId);
