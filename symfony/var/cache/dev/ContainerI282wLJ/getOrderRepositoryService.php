...
{
    /**
     * Gets the private 'App\Repository\Marketplace\OrderRepository' shared autowired service.
     *
     * @return \App\Repository\Marketplace\OrderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/Marketplace/OrderRepository.php';

        return $container->privates['App\\Repository\\Marketplace\\OrderRepository'] = new \App\Repository\Marketplace\OrderRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
