...
{
    /**
     * Gets the private 'App\Repository\Players\FriendshipRepository' shared autowired service.
     *
     * @return \App\Repository\Players\FriendshipRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/Players/FriendshipRepository.php';

        return $container->privates['App\\Repository\\Players\\FriendshipRepository'] = new \App\Repository\Players\FriendshipRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
