...
{
    /**
     * Gets the private 'App\Repository\Marketplace\ProductRepository' shared autowired service.
     *
     * @return \App\Repository\Marketplace\ProductRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/Marketplace/ProductRepository.php';

        return $container->privates['App\\Repository\\Marketplace\\ProductRepository'] = new \App\Repository\Marketplace\ProductRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
