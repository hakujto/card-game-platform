...
{
    /**
     * Gets the private 'App\Repository\Tournaments\GameRepository' shared autowired service.
     *
     * @return \App\Repository\Tournaments\GameRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/Tournaments/GameRepository.php';

        return $container->privates['App\\Repository\\Tournaments\\GameRepository'] = new \App\Repository\Tournaments\GameRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
