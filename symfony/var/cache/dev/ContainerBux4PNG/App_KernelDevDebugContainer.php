...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Api\\ApiIndexController' => 'getApiIndexControllerService',
            'App\\Controller\\Api\\Cards\\CardAbilityController' => 'getCardAbilityControllerService',
            'App\\Controller\\Api\\Cards\\CardController' => 'getCardControllerService',
            'App\\Controller\\Api\\Cards\\CardRulingController' => 'getCardRulingControllerService',
            'App\\Controller\\Api\\Cards\\CardSetController' => 'getCardSetControllerService',
            'App\\Controller\\Api\\Cards\\DeckCardController' => 'getDeckCardControllerService',
            'App\\Controller\\Api\\Cards\\DeckController' => 'getDeckControllerService',
            'App\\Controller\\Api\\Cards\\DeckSideboardCardController' => 'getDeckSideboardCardControllerService',
            'App\\Controller\\Api\\Cards\\DeckTagAssignmentController' => 'getDeckTagAssignmentControllerService',
            'App\\Controller\\Api\\Cards\\DeckTagController' => 'getDeckTagControllerService',
            'App\\Controller\\Api\\Content\\ArticleCommentController' => 'getArticleCommentControllerService',
            'App\\Controller\\Api\\Content\\ArticleController' => 'getArticleControllerService',
            'App\\Controller\\Api\\Content\\ArticleTagAssignmentController' => 'getArticleTagAssignmentControllerService',
            'App\\Controller\\Api\\Content\\ArticleTagController' => 'getArticleTagControllerService',
            'App\\Controller\\Api\\Content\\DraftParticipantController' => 'getDraftParticipantControllerService',
            'App\\Controller\\Api\\Content\\DraftPickController' => 'getDraftPickControllerService',
            'App\\Controller\\Api\\Content\\DraftSessionController' => 'getDraftSessionControllerService',
            'App\\Controller\\Api\\Content\\StreamController' => 'getStreamControllerService',
            'App\\Controller\\Api\\Marketplace\\CardPriceHistoryController' => 'getCardPriceHistoryControllerService',
            'App\\Controller\\Api\\Marketplace\\CouponController' => 'getCouponControllerService',
            'App\\Controller\\Api\\Marketplace\\OrderController' => 'getOrderControllerService',
            'App\\Controller\\Api\\Marketplace\\OrderItemController' => 'getOrderItemControllerService',
            'App\\Controller\\Api\\Marketplace\\ProductController' => 'getProductControllerService',
            'App\\Controller\\Api\\Marketplace\\TradeBidController' => 'getTradeBidControllerService',
            'App\\Controller\\Api\\Marketplace\\TradeDisputeController' => 'getTradeDisputeControllerService',
            'App\\Controller\\Api\\Marketplace\\TradeTransactionController' => 'getTradeTransactionControllerService',
            'App\\Controller\\Api\\Marketplace\\TradelistingController' => 'getTradelistingControllerService',
            'App\\Controller\\Api\\Players\\AchievementController' => 'getAchievementControllerService',
            'App\\Controller\\Api\\Players\\CraftingIngredientController' => 'getCraftingIngredientControllerService',
            'App\\Controller\\Api\\Players\\CraftingRecipeController' => 'getCraftingRecipeControllerService',
            'App\\Controller\\Api\\Players\\FriendshipController' => 'getFriendshipControllerService',
            'App\\Controller\\Api\\Players\\PlayerAchievementController' => 'getPlayerAchievementControllerService',
            'App\\Controller\\Api\\Players\\PlayerCollectionController' => 'getPlayerCollectionControllerService',
            'App\\Controller\\Api\\Players\\PlayerController' => 'getPlayerControllerService',
            'App\\Controller\\Api\\Players\\PlayerSeasonStatsController' => 'getPlayerSeasonStatsControllerService',
            'App\\Controller\\Api\\Tournaments\\AwardedPrizeController' => 'getAwardedPrizeControllerService',
            'App\\Controller\\Api\\Tournaments\\GameController' => 'getGameControllerService',
            'App\\Controller\\Api\\Tournaments\\MatchRecordController' => 'getMatchRecordControllerService',
            'App\\Controller\\Api\\Tournaments\\SeasonController' => 'getSeasonControllerService',
            'App\\Controller\\Api\\Tournaments\\TournamentController' => 'getTournamentControllerService',
            'App\\Controller\\Api\\Tournaments\\TournamentJudgeController' => 'getTournamentJudgeControllerService',
            'App\\Controller\\Api\\Tournaments\\TournamentPrizeController' => 'getTournamentPrizeControllerService',
            'App\\Controller\\Api\\Tournaments\\TournamentRegistrationController' => 'getTournamentRegistrationControllerService',
            'App\\Controller\\Api\\Tournaments\\TournamentRoundController' => 'getTournamentRoundControllerService',
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\Cards\\CardAbilityRepository' => ['privates', 'App\\Repository\\Cards\\CardAbilityRepository', 'getCardAbilityRepositoryService', true],
            'App\\Repository\\Cards\\CardRepository' => ['privates', 'App\\Repository\\Cards\\CardRepository', 'getCardRepositoryService', true],
            'App\\Repository\\Cards\\CardRulingRepository' => ['privates', 'App\\Repository\\Cards\\CardRulingRepository', 'getCardRulingRepositoryService', true],
            'App\\Repository\\Cards\\CardSetRepository' => ['privates', 'App\\Repository\\Cards\\CardSetRepository', 'getCardSetRepositoryService', true],
            'App\\Repository\\Cards\\DeckCardRepository' => ['privates', 'App\\Repository\\Cards\\DeckCardRepository', 'getDeckCardRepositoryService', true],
            'App\\Repository\\Cards\\DeckRepository' => ['privates', 'App\\Repository\\Cards\\DeckRepository', 'getDeckRepositoryService', true],
            'App\\Repository\\Cards\\DeckSideboardCardRepository' => ['privates', 'App\\Repository\\Cards\\DeckSideboardCardRepository', 'getDeckSideboardCardRepositoryService', true],
            'App\\Repository\\Cards\\DeckTagAssignmentRepository' => ['privates', 'App\\Repository\\Cards\\DeckTagAssignmentRepository', 'getDeckTagAssignmentRepositoryService', true],
            'App\\Repository\\Cards\\DeckTagRepository' => ['privates', 'App\\Repository\\Cards\\DeckTagRepository', 'getDeckTagRepositoryService', true],
            'App\\Repository\\Content\\ArticleCommentRepository' => ['privates', 'App\\Repository\\Content\\ArticleCommentRepository', 'getArticleCommentRepositoryService', true],
            'App\\Repository\\Content\\ArticleRepository' => ['privates', 'App\\Repository\\Content\\ArticleRepository', 'getArticleRepositoryService', true],
            'App\\Repository\\Content\\ArticleTagAssignmentRepository' => ['privates', 'App\\Repository\\Content\\ArticleTagAssignmentRepository', 'getArticleTagAssignmentRepositoryService', true],
            'App\\Repository\\Content\\ArticleTagRepository' => ['privates', 'App\\Repository\\Content\\ArticleTagRepository', 'getArticleTagRepositoryService', true],
            'App\\Repository\\Content\\DraftParticipantRepository' => ['privates', 'App\\Repository\\Content\\DraftParticipantRepository', 'getDraftParticipantRepositoryService', true],
            'App\\Repository\\Content\\DraftPickRepository' => ['privates', 'App\\Repository\\Content\\DraftPickRepository', 'getDraftPickRepositoryService', true],
            'App\\Repository\\Content\\DraftSessionRepository' => ['privates', 'App\\Repository\\Content\\DraftSessionRepository', 'getDraftSessionRepositoryService', true],
            'App\\Repository\\Content\\StreamRepository' => ['privates', 'App\\Repository\\Content\\StreamRepository', 'getStreamRepositoryService', true],
            'App\\Repository\\Marketplace\\CardPriceHistoryRepository' => ['privates', 'App\\Repository\\Marketplace\\CardPriceHistoryRepository', 'getCardPriceHistoryRepositoryService', true],
            'App\\Repository\\Marketplace\\CouponRepository' => ['privates', 'App\\Repository\\Marketplace\\CouponRepository', 'getCouponRepositoryService', true],
            'App\\Repository\\Marketplace\\OrderItemRepository' => ['privates', 'App\\Repository\\Marketplace\\OrderItemRepository', 'getOrderItemRepositoryService', true],
            'App\\Repository\\Marketplace\\OrderRepository' => ['privates', 'App\\Repository\\Marketplace\\OrderRepository', 'getOrderRepositoryService', true],
            'App\\Repository\\Marketplace\\ProductRepository' => ['privates', 'App\\Repository\\Marketplace\\ProductRepository', 'getProductRepositoryService', true],
            'App\\Repository\\Marketplace\\TradeBidRepository' => ['privates', 'App\\Repository\\Marketplace\\TradeBidRepository', 'getTradeBidRepositoryService', true],
            'App\\Repository\\Marketplace\\TradeDisputeRepository' => ['privates', 'App\\Repository\\Marketplace\\TradeDisputeRepository', 'getTradeDisputeRepositoryService', true],
            'App\\Repository\\Marketplace\\TradeTransactionRepository' => ['privates', 'App\\Repository\\Marketplace\\TradeTransactionRepository', 'getTradeTransactionRepositoryService', true],
            'App\\Repository\\Marketplace\\TradelistingRepository' => ['privates', 'App\\Repository\\Marketplace\\TradelistingRepository', 'getTradelistingRepositoryService', true],
            'App\\Repository\\Players\\AchievementRepository' => ['privates', 'App\\Repository\\Players\\AchievementRepository', 'getAchievementRepositoryService', true],
            'App\\Repository\\Players\\CraftingIngredientRepository' => ['privates', 'App\\Repository\\Players\\CraftingIngredientRepository', 'getCraftingIngredientRepositoryService', true],
            'App\\Repository\\Players\\CraftingRecipeRepository' => ['privates', 'App\\Repository\\Players\\CraftingRecipeRepository', 'getCraftingRecipeRepositoryService', true],
            'App\\Repository\\Players\\FriendshipRepository' => ['privates', 'App\\Repository\\Players\\FriendshipRepository', 'getFriendshipRepositoryService', true],
            'App\\Repository\\Players\\PlayerAchievementRepository' => ['privates', 'App\\Repository\\Players\\PlayerAchievementRepository', 'getPlayerAchievementRepositoryService', true],
            'App\\Repository\\Players\\PlayerCollectionRepository' => ['privates', 'App\\Repository\\Players\\PlayerCollectionRepository', 'getPlayerCollectionRepositoryService', true],
            'App\\Repository\\Players\\PlayerRepository' => ['privates', 'App\\Repository\\Players\\PlayerRepository', 'getPlayerRepositoryService', true],
            'App\\Repository\\Players\\PlayerSeasonStatsRepository' => ['privates', 'App\\Repository\\Players\\PlayerSeasonStatsRepository', 'getPlayerSeasonStatsRepositoryService', true],
            'App\\Repository\\Tournaments\\AwardedPrizeRepository' => ['privates', 'App\\Repository\\Tournaments\\AwardedPrizeRepository', 'getAwardedPrizeRepositoryService', true],
            'App\\Repository\\Tournaments\\GameRepository' => ['privates', 'App\\Repository\\Tournaments\\GameRepository', 'getGameRepositoryService', true],
            'App\\Repository\\Tournaments\\MatchRecordRepository' => ['privates', 'App\\Repository\\Tournaments\\MatchRecordRepository', 'getMatchRecordRepositoryService', true],
            'App\\Repository\\Tournaments\\SeasonRepository' => ['privates', 'App\\Repository\\Tournaments\\SeasonRepository', 'getSeasonRepositoryService', true],
            'App\\Repository\\Tournaments\\TournamentJudgeRepository' => ['privates', 'App\\Repository\\Tournaments\\TournamentJudgeRepository', 'getTournamentJudgeRepositoryService', true],
            'App\\Repository\\Tournaments\\TournamentPrizeRepository' => ['privates', 'App\\Repository\\Tournaments\\TournamentPrizeRepository', 'getTournamentPrizeRepositoryService', true],
            'App\\Repository\\Tournaments\\TournamentRegistrationRepository' => ['privates', 'App\\Repository\\Tournaments\\TournamentRegistrationRepository', 'getTournamentRegistrationRepositoryService', true],
            'App\\Repository\\Tournaments\\TournamentRepository' => ['privates', 'App\\Repository\\Tournaments\\TournamentRepository', 'getTournamentRepositoryService', true],
            'App\\Repository\\Tournaments\\TournamentRoundRepository' => ['privates', 'App\\Repository\\Tournaments\\TournamentRoundRepository', 'getTournamentRoundRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\Cards\\CardAbilityRepository' => '?',
            'App\\Repository\\Cards\\CardRepository' => '?',
            'App\\Repository\\Cards\\CardRulingRepository' => '?',
            'App\\Repository\\Cards\\CardSetRepository' => '?',
            'App\\Repository\\Cards\\DeckCardRepository' => '?',
            'App\\Repository\\Cards\\DeckRepository' => '?',
            'App\\Repository\\Cards\\DeckSideboardCardRepository' => '?',
            'App\\Repository\\Cards\\DeckTagAssignmentRepository' => '?',
            'App\\Repository\\Cards\\DeckTagRepository' => '?',
            'App\\Repository\\Content\\ArticleCommentRepository' => '?',
            'App\\Repository\\Content\\ArticleRepository' => '?',
            'App\\Repository\\Content\\ArticleTagAssignmentRepository' => '?',
            'App\\Repository\\Content\\ArticleTagRepository' => '?',
            'App\\Repository\\Content\\DraftParticipantRepository' => '?',
            'App\\Repository\\Content\\DraftPickRepository' => '?',
            'App\\Repository\\Content\\DraftSessionRepository' => '?',
            'App\\Repository\\Content\\StreamRepository' => '?',
            'App\\Repository\\Marketplace\\CardPriceHistoryRepository' => '?',
            'App\\Repository\\Marketplace\\CouponRepository' => '?',
            'App\\Repository\\Marketplace\\OrderItemRepository' => '?',
            'App\\Repository\\Marketplace\\OrderRepository' => '?',
            'App\\Repository\\Marketplace\\ProductRepository' => '?',
            'App\\Repository\\Marketplace\\TradeBidRepository' => '?',
            'App\\Repository\\Marketplace\\TradeDisputeRepository' => '?',
            'App\\Repository\\Marketplace\\TradeTransactionRepository' => '?',
            'App\\Repository\\Marketplace\\TradelistingRepository' => '?',
            'App\\Repository\\Players\\AchievementRepository' => '?',
            'App\\Repository\\Players\\CraftingIngredientRepository' => '?',
            'App\\Repository\\Players\\CraftingRecipeRepository' => '?',
            'App\\Repository\\Players\\FriendshipRepository' => '?',
            'App\\Repository\\Players\\PlayerAchievementRepository' => '?',
            'App\\Repository\\Players\\PlayerCollectionRepository' => '?',
            'App\\Repository\\Players\\PlayerRepository' => '?',
            'App\\Repository\\Players\\PlayerSeasonStatsRepository' => '?',
            'App\\Repository\\Tournaments\\AwardedPrizeRepository' => '?',
            'App\\Repository\\Tournaments\\GameRepository' => '?',
            'App\\Repository\\Tournaments\\MatchRecordRepository' => '?',
            'App\\Repository\\Tournaments\\SeasonRepository' => '?',
            'App\\Repository\\Tournaments\\TournamentJudgeRepository' => '?',
            'App\\Repository\\Tournaments\\TournamentPrizeRepository' => '?',
            'App\\Repository\\Tournaments\\TournamentRegistrationRepository' => '?',
            'App\\Repository\\Tournaments\\TournamentRepository' => '?',
            'App\\Repository\\Tournaments\\TournamentRoundRepository' => '?',
    ...
    protected static function getSerializerService($container)
    {
        ...
        $instance = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($c), new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, [], NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer([]), new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer([]), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $d), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer([]), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\NumberNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, []), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($e, $d, $c, $a, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($e), NULL, [], $a)], [new \Symfony\Component\Serializer\Encoder\XmlEncoder([]), new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, []), new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL, []), new \Symfony\Component\Serializer\Encoder\CsvEncoder([])], []);
