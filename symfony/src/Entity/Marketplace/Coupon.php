...
class Coupon
{
    ...
    {
        return ($this->getValidUntil() === null || ($this->getValidFrom() !== null && $this->getValidUntil() > $this->getValidFrom()));
    }
    ...
    public function validateImplies(): void
    {
        ...
        if ($this->getMaxUses() !== null && !(($this->getUsesCount() === null || ($this->getMaxUses() !== null && $this->getUsesCount() <= $this->getMaxUses())))) {
    ...
    public function isApplicableToOrder($orderTotal): mixed
    {
