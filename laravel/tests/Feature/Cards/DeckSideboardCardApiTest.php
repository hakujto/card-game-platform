...
class DeckSideboardCardApiTest extends TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $entity = DeckSideboardCard::create([
            'quantity' => 1,
    ...
    {
        $response = $this->getJson('/api/deck_sideboard_cards');
        $response->assertStatus(200);
    }

    public function test_create_returns_201(): void
    {
        $response = $this->postJson('/api/deck_sideboard_cards', [
            'quantity' => 1,
            'deck_id' => $this->depDeck->id,
            'card_id' => $this->depCard->id,
        ]);
    ...
    {
        $response = $this->getJson("/api/deck_sideboard_cards/{$this->entityId}");
        $response->assertStatus(200);
    }

    public function test_update_returns_200(): void
    {
        $response = $this->patchJson("/api/deck_sideboard_cards/{$this->entityId}", [
            'quantity' => 1,
        ]);
        $response->assertStatus(200);
    }
    ...
    public function test_create_fails_when_quantity_range_violated(): void
    {
        ...
        $response = $this->postJson('/api/deck_sideboard_cards', ['deck_id' => 1, 'card_id' => 1, 'quantity' => 5]);
