...
func TestTradeTransaction_Create(t *testing.T) {
	...
	body := map[string]interface{}{"final_price": 0.0, "platform_fee": 0, "status": "Pending", "completed_at": "2024-01-01T00:00:00Z", "listing_id": depTradelisting1ID, "buyer_id": depPlayer1ID, "seller_id": depPlayer1ID}
...
func TestTradeTransaction_Get(t *testing.T) {
	...
	created := postTradeTransaction(t, r, db, map[string]interface{}{"final_price": 0.0, "platform_fee": 0, "status": "Pending", "completed_at": "2024-01-01T00:00:00Z", "listing_id": depTradelisting2ID, "buyer_id": depPlayer2ID, "seller_id": depPlayer2ID})
...
func TestTradeTransaction_Update(t *testing.T) {
	...
	created := postTradeTransaction(t, r, db, map[string]interface{}{"final_price": 0.0, "platform_fee": 0, "status": "Pending", "completed_at": "2024-01-01T00:00:00Z", "listing_id": depTradelisting3ID, "buyer_id": depPlayer3ID, "seller_id": depPlayer3ID})
	id := fmt.Sprintf("%v", created["id"])
	upBody := map[string]interface{}{"final_price": 0.0}
...
func TestTradeTransaction_Delete(t *testing.T) {
	...
	created := postTradeTransaction(t, r, db, map[string]interface{}{"final_price": 0.0, "platform_fee": 0, "status": "Pending", "completed_at": "2024-01-01T00:00:00Z", "listing_id": depTradelisting4ID, "buyer_id": depPlayer4ID, "seller_id": depPlayer4ID})
	id := fmt.Sprintf("%v", created["id"])
	w := httptest.NewRecorder()
