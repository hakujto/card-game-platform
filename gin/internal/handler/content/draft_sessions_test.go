...
func TestDraftSession_Create(t *testing.T) {
	...
	_ = depCardSet1ID
	body := map[string]interface{}{"status": "WaitingForPlayers", "draft_type": "Booster", "seats": 1, "created_at": "2024-01-01T00:00:00Z", "card_set_id": depCardSet1ID}
...
func TestDraftSession_Get(t *testing.T) {
	...
	_ = depCardSet2ID
	created := postDraftSession(t, r, db, map[string]interface{}{"status": "WaitingForPlayers", "draft_type": "Booster", "seats": 1, "created_at": "2024-01-01T00:00:00Z", "card_set_id": depCardSet2ID})
...
func TestDraftSession_Update(t *testing.T) {
	...
	_ = depCardSet3ID
	created := postDraftSession(t, r, db, map[string]interface{}{"status": "WaitingForPlayers", "draft_type": "Booster", "seats": 1, "created_at": "2024-01-01T00:00:00Z", "card_set_id": depCardSet3ID})
	id := fmt.Sprintf("%v", created["id"])
	upBody := map[string]interface{}{"seats": 1}
...
func TestDraftSession_Delete(t *testing.T) {
	...
	_ = depCardSet4ID
	created := postDraftSession(t, r, db, map[string]interface{}{"status": "WaitingForPlayers", "draft_type": "Booster", "seats": 1, "created_at": "2024-01-01T00:00:00Z", "card_set_id": depCardSet4ID})
	id := fmt.Sprintf("%v", created["id"])
	w := httptest.NewRecorder()
