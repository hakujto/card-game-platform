...
func TestStream_Create(t *testing.T) {
	...
	_ = depPlayer1ID
	body := map[string]interface{}{"title": "test", "stream_url": "https://example.com", "platform": "Twitch", "status": "Live", "viewer_count_peak": 1, "scheduled_start": "2024-01-01T00:00:00Z", "streamer_id": depPlayer1ID}
...
func TestStream_Get(t *testing.T) {
	...
	_ = depPlayer2ID
	created := postStream(t, r, db, map[string]interface{}{"title": "test", "stream_url": "https://example.com", "platform": "Twitch", "status": "Live", "viewer_count_peak": 1, "scheduled_start": "2024-01-01T00:00:00Z", "streamer_id": depPlayer2ID})
...
func TestStream_Update(t *testing.T) {
	...
	_ = depPlayer3ID
	created := postStream(t, r, db, map[string]interface{}{"title": "test", "stream_url": "https://example.com", "platform": "Twitch", "status": "Live", "viewer_count_peak": 1, "scheduled_start": "2024-01-01T00:00:00Z", "streamer_id": depPlayer3ID})
	id := fmt.Sprintf("%v", created["id"])
...
func TestStream_Delete(t *testing.T) {
	...
	_ = depPlayer4ID
	created := postStream(t, r, db, map[string]interface{}{"title": "test", "stream_url": "https://example.com", "platform": "Twitch", "status": "Live", "viewer_count_peak": 1, "scheduled_start": "2024-01-01T00:00:00Z", "streamer_id": depPlayer4ID})
	id := fmt.Sprintf("%v", created["id"])
	w := httptest.NewRecorder()
