...
params_to_record(Id, Params) ->
    #deck{
        ...
        is_public  = maps:get(<<"is_public">>, Params, undefined),
        is_tournament_legal = maps:get(<<"is_tournament_legal">>, Params, undefined),
        archetype  = maps:get(<<"archetype">>, Params, undefined),
        wins       = maps:get(<<"wins">>, Params, undefined),
        losses     = maps:get(<<"losses">>, Params, undefined),
        draws      = maps:get(<<"draws">>, Params, undefined),
