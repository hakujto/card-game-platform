...
params_to_record(Id, Params) ->
    #product{
        ...
        product_type = maps:get(<<"product_type">>, Params, undefined),
        price      = maps:get(<<"price">>, Params, undefined),
        stock      = maps:get(<<"stock">>, Params, undefined),
        active     = maps:get(<<"active">>, Params, undefined),
        discount_percent = maps:get(<<"discount_percent">>, Params, undefined),
        description = maps:get(<<"description">>, Params, undefined),
        image_url  = maps:get(<<"image_url">>, Params, undefined),
        featured   = maps:get(<<"featured">>, Params, undefined),
