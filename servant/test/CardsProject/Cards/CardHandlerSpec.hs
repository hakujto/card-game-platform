...
spec = with (return app) $ do
  ...
  describe "POST /api/cards" $ do
    it "creates and returns 201" $ do
      let body = [json|{"publicId": "00000000-0000-0000-0000-000000000001", "name": "Test Lightning Bolt", "cardType": "Spell", "rarity": "Common", "manaCost": 0, "manaColors": "White", "attack": 1, "defense": 1, "loyalty": null, "description": "test", "flavorText": null, "imageUrl": null, "artistName": null, "legalFormats": "Standard", "isBanned": false, "isRestricted": false, "powerLevel": 1, "metadata": null, "totalCopiesInCirculation": 0, "setId": 1}|]
  ...
  describe "PUT /api/cards/1" $ do
    it "behavior replace stub returns 404 or 500" $ do
      resp <- request "PUT" "/api/cards/1" [("Content-Type","application/json")] "{}"
      liftIO $ statusCode (simpleStatus resp) `shouldSatisfy` \s -> s == 204 || s == 400 || s == 401 || s == 404 || s == 500
  ...
  describe "POST /api/cards rule creature_requires_stats" $ do
    it "rejects when creature_requires_stats violated" $ do
      let body = [json|{"publicId": "00000000-0000-0000-0000-000000000001", "name": "test", "cardType": "Creature", "rarity": "Common", "manaCost": 0, "manaColors": "White", "attack": null, "defense": 0, "loyalty": 0, "description": "test", "flavorText": "test", "imageUrl": "https://example.com", "artistName": "test", "legalFormats": "Standard", "isBanned": false, "isRestricted": false, "powerLevel": 0, "metadata": {}, "totalCopiesInCirculation": 0, "setId": 1}|]
  ...
  describe "POST /api/cards rule planeswalker_requires_loyalty" $ do
    it "rejects when planeswalker_requires_loyalty violated" $ do
      let body = [json|{"publicId": "00000000-0000-0000-0000-000000000001", "name": "test", "cardType": "Planeswalker", "rarity": "Common", "manaCost": 0, "manaColors": "White", "attack": 0, "defense": 0, "loyalty": null, "description": "test", "flavorText": "test", "imageUrl": "https://example.com", "artistName": "test", "legalFormats": "Standard", "isBanned": false, "isRestricted": false, "powerLevel": 0, "metadata": {}, "totalCopiesInCirculation": 0, "setId": 1}|]
      resp <- request "POST" "/api/cards" [("Content-Type","application/json")] body
      liftIO $ statusCode (simpleStatus resp) `shouldSatisfy` \s -> s == 400

  describe "POST /api/cards rule land_has_no_mana_cost" $ do
    it "rejects when land_has_no_mana_cost violated" $ do
      let body = [json|{"publicId": "00000000-0000-0000-0000-000000000001", "name": "test", "cardType": "Land", "rarity": "Common", "manaCost": 1, "manaColors": "White", "attack": 0, "defense": 0, "loyalty": 0, "description": "test", "flavorText": "test", "imageUrl": "https://example.com", "artistName": "test", "legalFormats": "Standard", "isBanned": false, "isRestricted": false, "powerLevel": 0, "metadata": {}, "totalCopiesInCirculation": 0, "setId": 1}|]
      resp <- request "POST" "/api/cards" [("Content-Type","application/json")] body
      liftIO $ statusCode (simpleStatus resp) `shouldSatisfy` \s -> s == 400

  describe "POST /api/cards rule spell_or_artifact_no_loyalty" $ do
    it "rejects when spell_or_artifact_no_loyalty violated" $ do
      let body = [json|{"publicId": "00000000-0000-0000-0000-000000000001", "name": "test", "cardType": "Creature", "rarity": "Common", "manaCost": 0, "manaColors": "White", "attack": 0, "defense": 0, "loyalty": "test", "description": "test", "flavorText": "test", "imageUrl": "https://example.com", "artistName": "test", "legalFormats": "Standard", "isBanned": false, "isRestricted": false, "powerLevel": 0, "metadata": {}, "totalCopiesInCirculation": 0, "setId": 1}|]
      resp <- request "POST" "/api/cards" [("Content-Type","application/json")] body
      liftIO $ statusCode (simpleStatus resp) `shouldSatisfy` \s -> s == 400

  describe "POST /api/cards rule mana_cost_range" $ do
    it "rejects when mana_cost_range violated" $ do
      let body = [json|{"publicId": "00000000-0000-0000-0000-000000000001", "name": "test", "cardType": "Creature", "rarity": "Common", "manaCost": 21, "manaColors": "White", "attack": 0, "defense": 0, "loyalty": 0, "description": "test", "flavorText": "test", "imageUrl": "https://example.com", "artistName": "test", "legalFormats": "Standard", "isBanned": false, "isRestricted": false, "powerLevel": 0, "metadata": {}, "totalCopiesInCirculation": 0, "setId": 1}|]
      resp <- request "POST" "/api/cards" [("Content-Type","application/json")] body
      liftIO $ statusCode (simpleStatus resp) `shouldSatisfy` \s -> s == 400

  describe "POST /api/cards rule power_level_range" $ do
    it "rejects when power_level_range violated" $ do
      let body = [json|{"publicId": "00000000-0000-0000-0000-000000000001", "name": "test", "cardType": "Creature", "rarity": "Common", "manaCost": 0, "manaColors": "White", "attack": 0, "defense": 0, "loyalty": 0, "description": "test", "flavorText": "test", "imageUrl": "https://example.com", "artistName": "test", "legalFormats": "Standard", "isBanned": false, "isRestricted": false, "powerLevel": 11, "metadata": {}, "totalCopiesInCirculation": 0, "setId": 1}|]
      resp <- request "POST" "/api/cards" [("Content-Type","application/json")] body
      liftIO $ statusCode (simpleStatus resp) `shouldSatisfy` \s -> s == 400
  ...
  describe "POST /api/cards rule banned_card_not_in_legal_formats" $ do
    it "rejects when banned_card_not_in_legal_formats violated" $ do
      let body = [json|{"publicId": "00000000-0000-0000-0000-000000000001", "name": "test", "cardType": "Creature", "rarity": "Common", "manaCost": 0, "manaColors": "White", "attack": 0, "defense": 0, "loyalty": 0, "description": "test", "flavorText": "test", "imageUrl": "https://example.com", "artistName": "test", "legalFormats": "Standard", "isBanned": true, "isRestricted": false, "powerLevel": 0, "metadata": {}, "totalCopiesInCirculation": 0, "setId": 1}|]
      resp <- request "POST" "/api/cards" [("Content-Type","application/json")] body
      liftIO $ statusCode (simpleStatus resp) `shouldSatisfy` \s -> s == 400
