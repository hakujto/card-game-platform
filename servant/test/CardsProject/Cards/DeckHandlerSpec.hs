...
spec = with (return app) $ do
  ...
  describe "POST /api/decks" $ do
    it "creates and returns 201" $ do
      let body = [json|{"name": "test", "description": "test", "format": "Standard", "isPublic": true, "isTournamentLegal": true, "archetype": "Aggro", "wins": 0, "losses": 0, "createdAt": "2024-01-01T00:00:00", "updatedAt": "2024-01-01T00:00:00", "playerId": 1}|]
