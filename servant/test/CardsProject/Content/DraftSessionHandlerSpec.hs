...
spec = do
  ...
  describe "POST /api/draft_sessions" $ do
    it "creates and returns 201" $ do
      let body = encode (object ["status" .= ("WaitingForPlayers"), "draftType" .= ("Booster"), "seats" .= (0), "createdAt" .= ("2024-01-01T00:00:00"), "completedAt" .= ("2024-01-01T00:00:00"), "cardSetId" .= ("test"), "participantsId" .= ("test")])
