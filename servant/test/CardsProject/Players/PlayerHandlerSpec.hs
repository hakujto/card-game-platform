...
spec = do
  ...
  describe "POST /api/players" $ do
    it "creates and returns 201" $ do
      let body = encode (object ["displayName" .= ("test"), "rank" .= ("Bronze"), "rating" .= (0), "peakRating" .= (0), "bio" .= ("test"), "countryCode" .= ("test"), "avatarUrl" .= ("https://example.com"), "preferredFormat" .= ("Standard"), "isVerified" .= (true), "createdAt" .= ("2024-01-01T00:00:00"), "lastActiveAt" .= ("2024-01-01T00:00:00"), "userId" .= ("test"), "seasonStatsId" .= ("test")])
