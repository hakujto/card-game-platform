...
spec = with (return app) $ do
  ...
  describe "POST /api/players" $ do
    it "creates and returns 201" $ do
      let body = [json|{"publicId": "00000000-0000-0000-0000-000000000001", "displayName": "test", "rank": "Bronze", "rating": 1000, "peakRating": 1000, "bio": null, "countryCode": null, "avatarUrl": null, "preferredFormat": null, "contactEmail": null, "winRateCached": null, "isVerified": false, "createdAt": "2024-01-01T00:00:00", "lastActiveAt": null, "userId": null}|]
  ...
  describe "POST /api/players rule rating_range" $ do
    it "rejects when rating_range violated" $ do
      let body = [json|{"publicId": "00000000-0000-0000-0000-000000000001", "displayName": "test", "rank": "Bronze", "rating": 10000, "peakRating": 0, "bio": "test", "countryCode": "test", "avatarUrl": "https://example.com", "preferredFormat": "Standard", "contactEmail": "test@example.com", "winRateCached": 0.0, "isVerified": false, "createdAt": "2024-01-01T00:00:00", "lastActiveAt": "2024-01-01T00:00:00", "userId": null}|]
  ...
  describe "POST /api/players rule display_name_not_empty" $ do
    it "rejects when display_name_not_empty violated" $ do
      let body = [json|{"publicId": "00000000-0000-0000-0000-000000000001", "displayName": null, "rank": "Bronze", "rating": 0, "peakRating": 0, "bio": "test", "countryCode": "test", "avatarUrl": "https://example.com", "preferredFormat": "Standard", "contactEmail": "test@example.com", "winRateCached": 0.0, "isVerified": false, "createdAt": "2024-01-01T00:00:00", "lastActiveAt": "2024-01-01T00:00:00", "userId": null}|]
      resp <- request "POST" "/api/players" [("Content-Type","application/json")] body
      liftIO $ statusCode (simpleStatus resp) `shouldSatisfy` \s -> s == 400
