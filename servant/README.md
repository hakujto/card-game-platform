...
**Requirements:** GHC 9.x, [cabal-install](https://www.haskell.org/cabal/), SQLite 3

```bash
bash setup.sh
```

> `setup.sh` creates the SQLite DB, applies the schema, builds, and starts the Warp server.
...
Stack: **Haskell + Servant + Warp + sqlite-simple + aeson**
