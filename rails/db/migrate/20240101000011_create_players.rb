class CreatePlayers < ActiveRecord::Migration[7.1]
  def change
    create_table :players do |t|
      ...
      t.integer :preferred_format, null: true # enum: { standard: 0, extended: 1, legacy: 2, vintage: 3, commander: 4, draft: 5 }
      t.string :contact_email, limit: 254, null: true
      t.float :win_rate_cached, null: true
