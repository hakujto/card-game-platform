class CreateGames < ActiveRecord::Migration[7.1]
  def change
    create_table :games do |t|
      ...
      t.integer :winner_side, null: false, default: 0 # enum: { player1: 0, player2: 1, draw: 2 }
      t.integer :turns_played, null: true
      t.integer :duration_seconds, null: true
      t.integer :ended_by, null: false, default: 0 # enum: { normal: 0, timeout: 1, concession: 2, draw_offer: 3 }
