class Deck < ApplicationRecord
  ...
  has_many :deck_cards, class_name: 'DeckCard', inverse_of: :deck
  has_many :deck_sideboard_cards, class_name: 'DeckSideboardCard', inverse_of: :deck
  has_many :tag_assignments, class_name: 'DeckTagAssignment', inverse_of: :deck
  has_many :tournament_registrations, class_name: 'TournamentRegistration', inverse_of: :deck
  has_many :articles, class_name: 'Article', inverse_of: :featured_deck
  belongs_to :player, class_name: 'Player', inverse_of: :decks
  has_many :cards, class_name: 'Card', through: :deck_cards, inverse_of: :decks
