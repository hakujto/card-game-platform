...
RSpec.describe "Api::Players::CraftingRecipes", type: :request do
  before(:each) do
    ...
    @dep_result_card = Card.create!({ public_id: SecureRandom.uuid, name: 'test', card_type: :spell, rarity: :common, mana_cost: 0, mana_colors: :white, attack: 1, defense: 1, loyalty: nil, description: 'test', legal_formats: :standard, is_banned: false, is_restricted: false, power_level: 1, total_copies_in_circulation: 1, set_id: @aux_card_set.id })
  end
