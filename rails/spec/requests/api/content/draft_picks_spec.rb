...
RSpec.describe "Api::Content::DraftPicks", type: :request do
  before(:each) do
    ...
    @aux_draft_session = DraftSession.create!({ status: :completed, draft_type: :booster, seats: 2, time_per_pick_seconds: 1, created_at: Time.now, completed_at: nil, card_set_id: @aux_card_set.id })
