...
public class AchievementApiTests : IClassFixture<AchievementApiTests.TestFactory>
{
    ...
    public AchievementApiTests(TestFactory factory)
    {
    ...
    {
        var response = await _client.GetAsync("/api/achievements?q=test");
        Assert.Equal(HttpStatusCode.OK, response.StatusCode);
    }
    [Fact]
