...
public class PlayerCollectionApiTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly HttpClient _client;

    public PlayerCollectionApiTests(WebApplicationFactory<Program> factory)
    {
