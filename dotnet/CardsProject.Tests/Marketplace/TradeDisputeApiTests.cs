...
public class TradeDisputeApiTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly HttpClient _client;

    public TradeDisputeApiTests(WebApplicationFactory<Program> factory)
    {
    ...
    {
        var response = await _client.DeleteAsync("/api/trade_disputes/1");
        Assert.True(
