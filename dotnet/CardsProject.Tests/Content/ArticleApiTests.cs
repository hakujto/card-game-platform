...
public class ArticleApiTests : IClassFixture<ArticleApiTests.TestFactory>
{
    ...
    {
        var response = await _client.GetAsync("/api/articles?q=test");
        Assert.Equal(HttpStatusCode.OK, response.StatusCode);
    }
    [Fact]
    public async Task Create_Fails_When_PublishedRequiresPublishedAt_Violated()
    {
        ...
        var content = new StringContent(@"{ ""AuthorId"": 1, ""Title"": ""test"", ""Slug"": ""test"", ""Body"": ""test"", ""ArticleType"": ""test"", ""Language"": ""test"", ""ViewCount"": 1, ""LikesCount"": 1, ""TotalViewsAlltime"": 1, ""IsFeatured"": true, ""CreatedAt"": ""2024-01-01T00:00:00"", ""UpdatedAt"": ""2024-01-01T00:00:00"", ""Status"": ""Published"", ""publishedAt"": null }", System.Text.Encoding.UTF8, "application/json");
    ...
    public async Task Create_Fails_When_ViewCountNotNegative_Violated()
    {
        ...
        var content = new StringContent(@"{ ""AuthorId"": 1, ""Status"": ""Published"", ""publishedAt"": ""2024-01-01T00:00:00"", ""Title"": ""test"", ""Slug"": ""test"", ""Body"": ""test"", ""ArticleType"": ""test"", ""Language"": ""test"", ""LikesCount"": 1, ""TotalViewsAlltime"": 1, ""IsFeatured"": true, ""CreatedAt"": ""2024-01-01T00:00:00"", ""UpdatedAt"": ""2024-01-01T00:00:00"", ""ViewCount"": -1 }", System.Text.Encoding.UTF8, "application/json");
        var response = await _client.PostAsync("/api/articles", content);
        Assert.Equal(HttpStatusCode.BadRequest, response.StatusCode);
    }
    ...
    public async Task Create_Fails_When_LikesCountNotNegative_Violated()
    {
        ...
        var content = new StringContent(@"{ ""AuthorId"": 1, ""Status"": ""Published"", ""publishedAt"": ""2024-01-01T00:00:00"", ""Title"": ""test"", ""Slug"": ""test"", ""Body"": ""test"", ""ArticleType"": ""test"", ""Language"": ""test"", ""ViewCount"": 1, ""TotalViewsAlltime"": 1, ""IsFeatured"": true, ""CreatedAt"": ""2024-01-01T00:00:00"", ""UpdatedAt"": ""2024-01-01T00:00:00"", ""LikesCount"": -1 }", System.Text.Encoding.UTF8, "application/json");
        var response = await _client.PostAsync("/api/articles", content);
        Assert.Equal(HttpStatusCode.BadRequest, response.StatusCode);
    }
    [Fact]
