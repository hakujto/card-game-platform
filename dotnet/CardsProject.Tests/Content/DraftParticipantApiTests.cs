...
public class DraftParticipantApiTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly HttpClient _client;

    public DraftParticipantApiTests(WebApplicationFactory<Program> factory)
    {
    ...
    public async Task Create_Returns201()
    {
        ...
        {
        SeatNumber = 1,
        JoinedAt = new DateTime(2024, 1, 1)
        };
