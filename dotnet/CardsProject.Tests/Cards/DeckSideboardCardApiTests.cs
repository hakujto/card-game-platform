...
public class DeckSideboardCardApiTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly HttpClient _client;

    public DeckSideboardCardApiTests(WebApplicationFactory<Program> factory)
    {
