defmodule CardsProject.Repo.Migrations.CreateArticles do
  ...
  def change do
    create table(:articles) do
      ...
      add :total_views_alltime, :integer, default: 0
      add :is_featured, :boolean, default: false
      add :published_at, :naive_datetime, null: true
      add :created_at, :naive_datetime
      add :author_id, references(:players, on_delete: :restrict)
      add :featured_deck_id, references(:decks, on_delete: :nilify_all), null: true
      add :comments_id, references(:article_comments, on_delete: :delete_all)
