defmodule CardsProject.Repo.Migrations.CreateMatches do
  ...
  def change do
    create table(:matches) do
      ...
      add :round_id, references(:tournament_rounds, on_delete: :delete_all), null: true
      add :player1_id, references(:players, on_delete: :restrict)
      add :player2_id, references(:players, on_delete: :nilify_all), null: true
      add :games_id, references(:games, on_delete: :delete_all), null: true
