...
class TestOrder:
    ...
    def test_create_returns_201(self, client: TestClient):
        ...
        data = {"status": "Pending", "total": 0, "discount_applied": 0.0, "currency": "xxx", "tracking_number": "test", "created_at": "2024-01-01T00:00:00", "paid_at": "2024-01-01T00:00:00", "player_id": _dep_player["id"]}
    ...
    def test_retrieve_returns_200(self, client: TestClient):
        _dep_player = client.post("/api/players", json={"display_name": "test", "rank": "Bronze", "rating": 0, "peak_rating": 1000, "is_verified": False, "created_at": "2024-01-01T00:00:00"}).json()
        created = client.post("/api/orders", json={"status": "Pending", "total": 0, "discount_applied": 0.0, "currency": "xxx", "tracking_number": "test", "created_at": "2024-01-01T00:00:00", "paid_at": "2024-01-01T00:00:00", "player_id": _dep_player["id"]}).json()
    ...
    def test_create_fails_when_paid_requires_paid_at_violated(self, client: TestClient):
        ...
        data = {"status": "Paid", "total": 0, "discount_applied": 0.0, "currency": "xxx", "created_at": "2024-01-01T00:00:00", "paid_at": None, "tracking_number": "test", "player_id": _dep_player["id"]}
        res = client.post("/api/orders", json=data)
    ...
    def test_create_fails_when_shipped_requires_tracking_violated(self, client: TestClient):
        _dep_player = client.post("/api/players", json={"display_name": "test", "rank": "Bronze", "rating": 0, "peak_rating": 1000, "is_verified": False, "created_at": "2024-01-01T00:00:00"}).json()
        # IMPLIES: antecedent=true, consequent violated → 422
        data = {"status": "Shipped", "total": 0, "discount_applied": 0.0, "currency": "xxx", "created_at": "2024-01-01T00:00:00", "paid_at": "2024-01-01T00:00:00", "tracking_number": None, "player_id": _dep_player["id"]}
        res = client.post("/api/orders", json=data)
        assert res.status_code == 422
    ...
    def test_create_fails_when_total_not_negative_violated(self, client: TestClient):
        ...
        data = {"status": "Shipped", "total": -1, "discount_applied": 0.0, "currency": "xxx", "created_at": "2024-01-01T00:00:00", "paid_at": "2024-01-01T00:00:00", "tracking_number": "test", "player_id": _dep_player["id"]}
        res = client.post("/api/orders", json=data)
        assert res.status_code == 422
    ...
    def test_create_fails_when_discount_not_exceed_total_violated(self, client: TestClient):
        _dep_player = client.post("/api/players", json={"display_name": "test", "rank": "Bronze", "rating": 0, "peak_rating": 1000, "is_verified": False, "created_at": "2024-01-01T00:00:00"}).json()
        # Simple rule violated → 422
        data = {"status": "Shipped", "total": 1, "discount_applied": 99999, "currency": "xxx", "created_at": "2024-01-01T00:00:00", "paid_at": "2024-01-01T00:00:00", "tracking_number": "test", "player_id": _dep_player["id"]}
        res = client.post("/api/orders", json=data)
        assert res.status_code == 422
...
class TestCoupon:
    ...
    def test_create_returns_201(self, client: TestClient):
        data = {"code": "test", "discount_type": "Percent", "discount_value": 1, "min_order_value": 0.0, "uses_count": 0, "valid_from": "2024-01-01T00:00:00", "valid_until": "2024-01-01T00:00:01", "is_active": False}
        res = client.post("/api/coupons", json=data)
        assert res.status_code == 201
        assert "id" in res.json()

    def test_retrieve_returns_200(self, client: TestClient):
        created = client.post("/api/coupons", json={"code": "test", "discount_type": "Percent", "discount_value": 1, "min_order_value": 0.0, "uses_count": 0, "valid_from": "2024-01-01T00:00:00", "valid_until": "2024-01-01T00:00:01", "is_active": False}).json()
    ...
    def test_create_fails_when_percent_discount_range_violated(self, client: TestClient):
        # IMPLIES: antecedent=true, consequent violated → 422
        data = {"code": "test", "discount_type": "Percent", "discount_value": 101, "min_order_value": 0.0, "uses_count": 0, "valid_from": "2024-01-01T00:00:00", "valid_until": "2024-01-01T00:00:01", "is_active": False}
        res = client.post("/api/coupons", json=data)
        assert res.status_code == 422
...
class TestTradelisting:
    ...
    def test_retrieve_returns_200(self, client: TestClient):
        ...
        _dep_card_set = client.post("/api/card_sets", json={"name": "test", "code": "test", "release_date": "2024-01-01", "set_type": "Core", "total_cards": 0}).json()
        _dep_card = client.post("/api/cards", json={"name": "test", "card_type": "Creature", "rarity": "Common", "mana_cost": 0, "mana_colors": "White", "description": "test", "legal_formats": "Standard", "is_banned": False, "is_restricted": False, "power_level": 1, "attack": 0, "defense": 0, "loyalty": 0, "set_id": _dep_card_set["id"]}).json()
        created = client.post("/api/tradelistings", json={"listing_type": "FixedPrice", "asking_price": 0.0, "auction_start_price": 0.0, "auction_end_time": "2024-01-01T00:00:00", "foil": False, "condition": "Mint", "quantity": 1, "status": "Active", "created_at": "2024-01-01T00:00:00", "seller_id": _dep_player["id"], "card_id": _dep_card["id"]}).json()
...
class TestTradeBid:
    ...
    def test_create_returns_201(self, client: TestClient):
        ...
        _dep_card_set = client.post("/api/card_sets", json={"name": "test", "code": "test", "release_date": "2024-01-01", "set_type": "Core", "total_cards": 0}).json()
        _dep_card = client.post("/api/cards", json={"name": "test", "card_type": "Creature", "rarity": "Common", "mana_cost": 0, "mana_colors": "White", "description": "test", "legal_formats": "Standard", "is_banned": False, "is_restricted": False, "power_level": 1, "attack": 0, "defense": 0, "loyalty": 0, "set_id": _dep_card_set["id"]}).json()
        _dep_tradelisting = client.post("/api/tradelistings", json={"listing_type": "FixedPrice", "foil": False, "condition": "Mint", "quantity": 1, "status": "Active", "created_at": "2024-01-01T00:00:00", "asking_price": 0.0, "auction_start_price": 0.0, "auction_end_time": "2024-01-01T00:00:00", "seller_id": _dep_player["id"], "card_id": _dep_card["id"]}).json()
        data = {"amount": 1, "placed_at": "2024-01-01T00:00:00", "is_winning": False, "listing_id": _dep_tradelisting["id"], "bidder_id": _dep_player["id"]}
    ...
    def test_retrieve_returns_200(self, client: TestClient):
        ...
        _dep_card = client.post("/api/cards", json={"name": "test", "card_type": "Creature", "rarity": "Common", "mana_cost": 0, "mana_colors": "White", "description": "test", "legal_formats": "Standard", "is_banned": False, "is_restricted": False, "power_level": 1, "attack": 0, "defense": 0, "loyalty": 0, "set_id": _dep_card_set["id"]}).json()
        _dep_tradelisting = client.post("/api/tradelistings", json={"listing_type": "FixedPrice", "foil": False, "condition": "Mint", "quantity": 1, "status": "Active", "created_at": "2024-01-01T00:00:00", "asking_price": 0.0, "auction_start_price": 0.0, "auction_end_time": "2024-01-01T00:00:00", "seller_id": _dep_player["id"], "card_id": _dep_card["id"]}).json()
        created = client.post("/api/trade_bids", json={"amount": 1, "placed_at": "2024-01-01T00:00:00", "is_winning": False, "listing_id": _dep_tradelisting["id"], "bidder_id": _dep_player["id"]}).json()
    ...
    def test_create_fails_when_amount_positive_violated(self, client: TestClient):
        ...
        _dep_tradelisting = client.post("/api/tradelistings", json={"listing_type": "FixedPrice", "foil": False, "condition": "Mint", "quantity": 1, "status": "Active", "created_at": "2024-01-01T00:00:00", "asking_price": 0.0, "auction_start_price": 0.0, "auction_end_time": "2024-01-01T00:00:00", "seller_id": _dep_player["id"], "card_id": _dep_card["id"]}).json()
        # Simple rule violated → 422
        data = {"amount": 0, "placed_at": "2024-01-01T00:00:00", "is_winning": False, "listing_id": _dep_tradelisting["id"], "bidder_id": _dep_player["id"]}
        res = client.post("/api/trade_bids", json=data)
        assert res.status_code == 422
...
class TestTradeTransaction:
    ...
    def test_create_returns_201(self, client: TestClient):
        ...
        _dep_card = client.post("/api/cards", json={"name": "test", "card_type": "Creature", "rarity": "Common", "mana_cost": 0, "mana_colors": "White", "description": "test", "legal_formats": "Standard", "is_banned": False, "is_restricted": False, "power_level": 1, "attack": 0, "defense": 0, "loyalty": 0, "set_id": _dep_card_set["id"]}).json()
        _dep_tradelisting = client.post("/api/tradelistings", json={"listing_type": "FixedPrice", "foil": False, "condition": "Mint", "quantity": 1, "status": "Active", "created_at": "2024-01-01T00:00:00", "asking_price": 0.0, "auction_start_price": 0.0, "auction_end_time": "2024-01-01T00:00:00", "seller_id": _dep_player["id"], "card_id": _dep_card["id"]}).json()
        data = {"final_price": 0.0, "platform_fee": 0.0, "status": "Pending", "completed_at": "2024-01-01T00:00:00", "listing_id": _dep_tradelisting["id"], "buyer_id": _dep_player["id"], "seller_id": _dep_player["id"]}
    ...
    def test_retrieve_returns_200(self, client: TestClient):
        ...
        _dep_card = client.post("/api/cards", json={"name": "test", "card_type": "Creature", "rarity": "Common", "mana_cost": 0, "mana_colors": "White", "description": "test", "legal_formats": "Standard", "is_banned": False, "is_restricted": False, "power_level": 1, "attack": 0, "defense": 0, "loyalty": 0, "set_id": _dep_card_set["id"]}).json()
        _dep_tradelisting = client.post("/api/tradelistings", json={"listing_type": "FixedPrice", "foil": False, "condition": "Mint", "quantity": 1, "status": "Active", "created_at": "2024-01-01T00:00:00", "asking_price": 0.0, "auction_start_price": 0.0, "auction_end_time": "2024-01-01T00:00:00", "seller_id": _dep_player["id"], "card_id": _dep_card["id"]}).json()
        created = client.post("/api/trade_transactions", json={"final_price": 0.0, "platform_fee": 0.0, "status": "Pending", "completed_at": "2024-01-01T00:00:00", "listing_id": _dep_tradelisting["id"], "buyer_id": _dep_player["id"], "seller_id": _dep_player["id"]}).json()
    ...
    def test_create_fails_when_fee_not_exceed_price_violated(self, client: TestClient):
        ...
        _dep_tradelisting = client.post("/api/tradelistings", json={"listing_type": "FixedPrice", "foil": False, "condition": "Mint", "quantity": 1, "status": "Active", "created_at": "2024-01-01T00:00:00", "asking_price": 0.0, "auction_start_price": 0.0, "auction_end_time": "2024-01-01T00:00:00", "seller_id": _dep_player["id"], "card_id": _dep_card["id"]}).json()
        # Simple rule violated → 422
        data = {"final_price": 1, "platform_fee": 99999, "status": "Completed", "completed_at": "2024-01-01T00:00:00", "listing_id": _dep_tradelisting["id"], "buyer_id": _dep_player["id"], "seller_id": _dep_player["id"]}
        res = client.post("/api/trade_transactions", json=data)
        assert res.status_code == 422
    ...
    def test_create_fails_when_fee_not_negative_violated(self, client: TestClient):
        ...
        _dep_tradelisting = client.post("/api/tradelistings", json={"listing_type": "FixedPrice", "foil": False, "condition": "Mint", "quantity": 1, "status": "Active", "created_at": "2024-01-01T00:00:00", "asking_price": 0.0, "auction_start_price": 0.0, "auction_end_time": "2024-01-01T00:00:00", "seller_id": _dep_player["id"], "card_id": _dep_card["id"]}).json()
        # Simple rule violated → 422
        data = {"final_price": 0.0, "platform_fee": -1, "status": "Completed", "completed_at": "2024-01-01T00:00:00", "listing_id": _dep_tradelisting["id"], "buyer_id": _dep_player["id"], "seller_id": _dep_player["id"]}
        res = client.post("/api/trade_transactions", json=data)
        assert res.status_code == 422
    ...
    def test_create_fails_when_completed_requires_completed_at_violated(self, client: TestClient):
        ...
        _dep_tradelisting = client.post("/api/tradelistings", json={"listing_type": "FixedPrice", "foil": False, "condition": "Mint", "quantity": 1, "status": "Active", "created_at": "2024-01-01T00:00:00", "asking_price": 0.0, "auction_start_price": 0.0, "auction_end_time": "2024-01-01T00:00:00", "seller_id": _dep_player["id"], "card_id": _dep_card["id"]}).json()
        # IMPLIES: antecedent=true, consequent violated → 422
        data = {"final_price": 0.0, "platform_fee": 0.0, "status": "Completed", "completed_at": None, "listing_id": _dep_tradelisting["id"], "buyer_id": _dep_player["id"], "seller_id": _dep_player["id"]}
        res = client.post("/api/trade_transactions", json=data)
        assert res.status_code == 422
...
class TestTradeDispute:
    ...
    def test_create_returns_201(self, client: TestClient):
        ...
        _dep_card = client.post("/api/cards", json={"name": "test", "card_type": "Creature", "rarity": "Common", "mana_cost": 0, "mana_colors": "White", "description": "test", "legal_formats": "Standard", "is_banned": False, "is_restricted": False, "power_level": 1, "attack": 0, "defense": 0, "loyalty": 0, "set_id": _dep_card_set["id"]}).json()
        _dep_tradelisting = client.post("/api/tradelistings", json={"listing_type": "FixedPrice", "foil": False, "condition": "Mint", "quantity": 1, "status": "Active", "created_at": "2024-01-01T00:00:00", "asking_price": 0.0, "auction_start_price": 0.0, "auction_end_time": "2024-01-01T00:00:00", "seller_id": _dep_player["id"], "card_id": _dep_card["id"]}).json()
        _dep_trade_transaction = client.post("/api/trade_transactions", json={"final_price": 0.0, "platform_fee": 0.0, "status": "Pending", "completed_at": "2024-01-01T00:00:00", "listing_id": _dep_tradelisting["id"], "buyer_id": _dep_player["id"], "seller_id": _dep_player["id"]}).json()
    ...
    def test_create_fails_when_resolved_at_requires_terminal_status_violated(self, client: TestClient):
        ...
        _dep_trade_transaction = client.post("/api/trade_transactions", json={"final_price": 0.0, "platform_fee": 0.0, "status": "Pending", "completed_at": "2024-01-01T00:00:00", "listing_id": _dep_tradelisting["id"], "buyer_id": _dep_player["id"], "seller_id": _dep_player["id"]}).json()
        # IMPLIES: antecedent=true, consequent violated → 422
        data = {"reason": "ItemNotReceived", "description": "test", "status": "Open", "opened_at": "2024-01-01T00:00:00", "transaction_id": _dep_trade_transaction["id"], "opened_by_id": _dep_player["id"], "resolved_at": "2024-01-01T00:00:00"}
        res = client.post("/api/trade_disputes", json=data)
        assert res.status_code == 422
