...
class TestArticle:
    ...
    def test_create_returns_201(self, client: TestClient):
        _dep_player = client.post("/api/players", json={"display_name": "test", "rank": "Bronze", "rating": 0, "peak_rating": 0, "is_verified": False, "created_at": "2024-01-01T00:00:00"}).json()
        data = {"title": "test", "slug": "test", "body": "test", "status": "Draft", "article_type": "Guide", "view_count": 0, "created_at": "2024-01-01T00:00:00", "updated_at": "2024-01-01T00:00:00", "author_id": _dep_player["id"]}
    ...
    def test_retrieve_returns_200(self, client: TestClient):
        _dep_player = client.post("/api/players", json={"display_name": "test", "rank": "Bronze", "rating": 0, "peak_rating": 0, "is_verified": False, "created_at": "2024-01-01T00:00:00"}).json()
        created = client.post("/api/articles", json={"title": "test", "slug": "test", "body": "test", "status": "Draft", "article_type": "Guide", "view_count": 0, "created_at": "2024-01-01T00:00:00", "updated_at": "2024-01-01T00:00:00", "author_id": _dep_player["id"]}).json()
...
class TestArticleTagAssignment:
    ...
    def test_create_returns_201(self, client: TestClient):
        _dep_player = client.post("/api/players", json={"display_name": "test", "rank": "Bronze", "rating": 0, "peak_rating": 0, "is_verified": False, "created_at": "2024-01-01T00:00:00"}).json()
        _dep_article = client.post("/api/articles", json={"title": "test", "slug": "test", "body": "test", "status": "Draft", "article_type": "Guide", "view_count": 0, "created_at": "2024-01-01T00:00:00", "updated_at": "2024-01-01T00:00:00", "author_id": _dep_player["id"]}).json()
