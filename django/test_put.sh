...
curl -s -X PUT "$BASE/tournaments/$ID_Tournament/" \
  -H "Content-Type: application/json" \
  -d "{\"public_id\": \"$(uuidgen | tr '[:upper:]' '[:lower:]')\", \"name\": \"Test Tournament Alpha\", \"description\": \"foo_description\", \"status\": \"Draft\", \"bracket_data\": {}, \"format\": \"Standard\", \"tournament_type\": \"Swiss\", \"max_players\": 8, \"entry_fee\": 0, \"prize_pool\": 0, \"startTime\": \"2024-01-01T00:00:00Z\", \"endTime\": null, \"is_online\": true, \"location\": \"foo_location\", \"rules_text\": \"foo_rules_text\", \"createdAt\": \"2024-01-01T00:00:00Z\", \"season\": ${ID_Season:-null}, \"organizer\": ${ID_Player:-null}}" | python3 -m json.tool
