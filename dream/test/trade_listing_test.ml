...
let suite_trade_listing = [
  ...
  Alcotest.test_case "GET /api/trade_listings/<id> returns 200" `Quick (lwt_run test_get_trade_listing);
  Alcotest.test_case "PATCH /api/trade_listings/<id> returns 200" `Quick (lwt_run test_update_trade_listing);
