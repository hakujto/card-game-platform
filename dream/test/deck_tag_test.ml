...
let suite_deck_tag = [
  ...
  Alcotest.test_case "GET /api/deck_tags/1 returns 200" `Quick (lwt_run test_get_deck_tag);
  Alcotest.test_case "PATCH /api/deck_tags/1 returns 200" `Quick (lwt_run test_update_deck_tag);
  Alcotest.test_case "DELETE /api/deck_tags/1 returns 204" `Quick (lwt_run test_delete_deck_tag);
]
