# CardsProject — Ktor REST API

## Stack

- Kotlin 2.2+
- Ktor 3.5
- Exposed 0.61 (SQL DSL)
- SQLite (via xerial driver)
- JUnit 5

## Prerequisites

- Java 21+
- Gradle 8+ (brew install gradle on macOS)
...
sets up Java 21 (Temurin), builds with Gradle, and runs JUnit 5 tests.
